...
public class AttractionActivity extends AppCompatActivity{
    ...
    private final MyWebView myWebView = new MyWebView();

    FragmentManager mFragmentManager;

    private FrameLayout titleFrameLayout, webFrameLayout;
    private static final int MATCH_PARENT = LinearLayout.LayoutParams.MATCH_PARENT;
    private static final String TITLE = "Attractions";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleArray = getResources().getStringArray(R.array.AttractionTitles);
        webArray = getResources().getStringArray(R.array.AttractionUrls);


        // Get references to the TitleFragment and to the QuotesFragment
        titleFrameLayout = (FrameLayout) findViewById(R.id.attraction_fragment_container);
        webFrameLayout = (FrameLayout) findViewById(R.id.attractionUrl_fragment_container);
        ...
        model.getSelectedItem().observe(this, item -> {
            if (!myWebView.isAdded()) {
                ...
                // add url fragment to display
                fragmentTransaction2.replace(R.id.attractionUrl_fragment_container,
                        myWebView);
